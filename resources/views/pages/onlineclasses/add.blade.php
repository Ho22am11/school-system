                ...
                <div class="card-body">
                    <form action="{{ route('online_classes.store') }}" method="post"   >
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label"> {{ trans('students.time') }} </label>
...
<script>
    $(document).ready(function() {
        $('select[name="classrooms"]').on('change', function() {
            ...
            if (GradeId) {
                $.ajax({
                    url: "{{ URL::to('sections') }}/" + GradeId,
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
                        $('select[name="section_id"]').empty();
                        $('select[name="section_id"]').append('<option  selected> {{ trans('parent.Choose') }}</option>');
                        $.each(data, function(key, value) {
