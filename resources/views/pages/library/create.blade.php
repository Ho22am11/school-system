...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Library.add_book')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('libraries.store') }}" method="post"   >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="academic_year">{{ __('parent.Attachments')}} : <span class="text-danger"></label>
                                <input type="file" accept="application/pdf" name="photos" >
