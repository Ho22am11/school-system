...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
		 				<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائيمة الفواتير</span>
						</div>
					</div>
					...
					<script>
						window.onload = function() {
							notif({
			     			...
			     			@endif
					@if (session()->has('change_invoice'))
					<script>
						window.onload = function() {
							notif({
								msg: "تم تغير حاله الدفع بنجاح",
								type: "success"
							})
						}
						...
						<div class="card">
                         ...
                         <strong>{{ session()->get('edit') }}</strong>
							...
							<div class="col-sm-6 col-md-4 col-xl-3">
                                <a class="modal-effect btn btn-outline-primary btn-block" href="{{ url('involces/create') }}">اضافه فاتوره </a>
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu tx-13">
															...
															<a class="dropdown-item" href="{{ url('edit_inv') }}/ {{ $invoice->id  }}">تعديل </a>
                                                            ...
                                                            @can('تغير حالة الدفع')
																...
																<a class="dropdown-item" href="print_invoice/{{ $invoice->id  }}"><i class="text-danger fas fa-print"></i>&nbsp;&nbsp;طباعه
																	الفاتورة</a>
                                                                @endcan
