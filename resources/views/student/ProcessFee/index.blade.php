...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('students.Exemption_fee')}}
							...
							<div class="card-body">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td> 
                                        <a href="{{ route('recepit_student.edit' , $process_fee->id )}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    </td>
                                    <td>
