				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='involces_paied') }}">  الفواتير المدفوعه</a></li>
                            @endcan
                            @can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='involces_unpaied') }}">الفواتير الغير المدفوعه </a></li>
                            @endcan
                            @can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='involces_hafpaied') }}">  الفواتير المدفوعه جزئيآ</a></li>
                            @endcan
                            @can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='delete_involces') }}">الفواتير المحذوفه </a></li>
                            @endcan
                            @can('ارشيف الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('الاقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='section') }}">اضافه قسم</a></li>
                            @endcan
                            @can('المنتجات')
