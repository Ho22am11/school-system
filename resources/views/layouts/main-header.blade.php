				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						<ul class="nav">
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/Palestine_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
							...
							<li class="dropdown nav-itemd-none d-md-flex">
								<a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
									<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
										<!-- You can dynamically generate the flag image URL based on the locale -->
										@if(LaravelLocalization::getCurrentLocale() == 'en')
											<img src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}" alt="English Flag">
										@elseif(LaravelLocalization::getCurrentLocale() == 'ar')
											<img src="{{ URL::asset('assets/img/flags/Palestine_flag.jpg') }}" alt="Arabic Flag">
										@endif
									</span>
									<div class="my-auto">
										...
										@elseif(LaravelLocalization::getCurrentLocale() == 'ar')
											<li class="">
												<a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="dropdown-item d-flex">
													<span class="avatar ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="English Flag"></span>
													<div class="d-flex">
